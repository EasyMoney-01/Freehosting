...
db.serialize(() => {
  ...
  db.run(
    "CREATE TABLE IF NOT EXISTS services (id TEXT PRIMARY KEY, owner_id TEXT, name TEXT, status TEXT, port INTEGER, source_info TEXT, created_at INTEGER, updated_at INTEGER)"
  );
});
